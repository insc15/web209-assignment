...
const PageAddUser = () => {
    const {handleSubmit,formState:{errors},register}=useForm<AddUserForm>()
...
<form className="m-12" onSubmit={handleSubmit(onSubmit)}>
    <h1 className="text-3xl">Thêm người dùng Admin</h1>
    <input type="text" readOnly hidden defaultValue="admin"{...register("role")} />
    <div className="relative z-0 w-full mb-6 group">
    <input type="text" id="name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required {...register("name")}/>
